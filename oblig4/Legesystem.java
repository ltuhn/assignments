...
public class Legesystem {
    ...
    public static void main(String[] args) { //kommandoløkke for brukeren (E2)
        ...
        String fortsett = "";
        Scanner brukerInp = new Scanner(System.in);
                    ...
                    try {
                        if (biter2[0].indexOf("#") != -1) {
                            ...
                            for (Legemiddel legemiddel : legemidler) {
                                ...
                                } else if (legemiddelNr > legemidler.stoerrelse()) {
                                    System.out.println("Ugyldig legemiddel ID.");
                                }
                            }
                            for (Pasient pasient : pasienter) {
                                if (pasient.hentId() == pasientId) {
                                    riktigPasient = pasient;
                                } else if (pasientId > pasienter.stoerrelse()) {
                            ...
                            for (Lege lege : leger) {
                                if (lege.hentNavn().equalsIgnoreCase(legeNavn)) {
                                    ...
                                    if (legemiddelType.equalsIgnoreCase("p")) {
                                        try {
    ...
    public static void skrivUt() {
        for (Lege lege : leger) {
            if (lege.hentReseptListe().stoerrelse() == 0) {
                System.out.println(lege.hentNavn() + " har ikke skrevet ut noen resepter.");
            } else {
    ...
    public static void leggTilKategori() throws NumberFormatException, UlovligUtskrift {
        String kategori;
        ...
        if (kategori.equalsIgnoreCase("pasient")) {
            ...
            try {
                ...
                System.out.println("Vennligst skriv inn et gyldig tall: 1 (narkotisk) / 2 (vanedannende) / 3 (vanlig)");
                leggTilKategori();
            } catch (NumberFormatException e) {
                System.out.println(e);
            }
    ...
    public static void velgResept(int valgtPasientID) throws NumberFormatException, UgyldigListeIndeks {
        Scanner inp = new Scanner(System.in);
        for (Pasient p : pasienter) {
            if (valgtPasientID == p.hentId()) {
                if (p.hentListeStoerrelse() == 0) {
                    ...
                    System.out.println(p.hentReseptListe());
                }
    ...
    public static void hentStatistikk() {
